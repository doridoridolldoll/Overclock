          ...
          <form class="validation-form" @submit.prevent>
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control readonly" v-model="state.nickname" id="nickname" readonly>
                <div class="invalid-feedback">
                  닉네임을 입력해주세요.
                </div>
              </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control readonly" v-model="state.phone" id="phone" readonly>
              <div class="invalid-feedback">
                전화번호를 입력해주세요.
              </div>
            </div>
...
export default {
  ...
  setup() {
    ...
    //   alert('회원가입에 실패하였습니다.')
    // }
    // router.push({name: "ProfileModify"});
    // }
    return { state}
  }
}
