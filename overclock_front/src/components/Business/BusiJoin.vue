<template>
            ...
            <div class="input-form2 col-md-12 mx-auto">
              ...
              <form class="validation-form" @submit.prevent>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" v-model="state.copname" id="copname" placeholder="" required>
                ...
                <div class="mb-3">
                  ...
                  <input type="copcode" class="form-control" v-model="state.copcode" id="copcode" placeholder="" required>
                  <div class="invalid-feedback">
                    사업자등록번호를 입력해주세요.
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" v-model="state.coppassword" id="coppassword">
                  <div class="invalid-feedback">
                    비밀번호를 입력해주세요.
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" v-model="state.recoppassword" id="recoppassword">
                  <div class="invalid-feedback">
                    비밀번호를 입력해주세요.
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" v-model="state.copphone" id="copphone" placeholder="010-0000-0000" required>
                  <div class="invalid-feedback">
                    전화번호를 입력해주세요.
                  </div>
                </div>
  ...
  setup(){
    ...
    const joinHandler = async() => {
      ...
      const body = {
        id : state.id,
        copcode : state.copcode,
        coppassword : state.coppassword,
        copname : state.copname,
        phone : state.phone,
        city : state.city,
        street : state.street,
